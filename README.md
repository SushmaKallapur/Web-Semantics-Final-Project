...
1.	Download/Pull full project code from https://github.com/SushmaKallapur/Web-Semantics-Final-Project
...
![alt text](https://github.com/SushmaKallapur/Web-Semantics-Final-Project/blob/master/referenceimages/tomcat_users_setting.png?raw=true)  
...
![alt text](https://github.com/SushmaKallapur/Web-Semantics-Final-Project/blob/master/referenceimages/tomcat_home.png?raw=true)
...
![alt text](https://github.com/SushmaKallapur/Web-Semantics-Final-Project/blob/master/referenceimages/tomcat_upload_war.png?raw=true)
